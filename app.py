...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with phrase_col:
        ...
        for d in kw_data:
            ...
            # Build positive keyword pills + bars
            pos_bars_html = ""
            for kw, cnt in d["top_pos"]:
                ...
                <div style='display:flex;align-items:center;gap:0.45rem;margin-bottom:0.28rem'>
                    ...
                    <div style='flex:1;background:rgba(5,150,105,0.08);border-radius:999px;
                        ...
                        <div style='background:#059669;width:{bar_w}%;height:5px;
                                    border-radius:999px;opacity:0.82'></div>
                    </div>
                    <span style='font-size:0.63rem;color:var(--text-3);
                                 font-family:"DM Mono",monospace;width:20px;
                                 text-align:right;flex-shrink:0'>{cnt}</span>
                </div>"""

            # Build negative keyword pills + bars
            neg_bars_html = ""
            for kw, cnt in d["top_neg"]:
                ...
                <div style='display:flex;align-items:center;gap:0.45rem;margin-bottom:0.28rem'>
                    ...
                    <div style='flex:1;background:rgba(220,38,38,0.08);border-radius:999px;
                                height:5px;overflow:hidden;min-width:40px'>
                        <div style='background:#dc2626;width:{bar_w}%;height:5px;
                                    border-radius:999px;opacity:0.82'></div>
                    </div>
                    <span style='font-size:0.63rem;color:var(--text-3);
                                 font-family:"DM Mono",monospace;width:20px;
            ...
            if not pos_bars_html:
                pos_bars_html = "<span style='font-size:0.67rem;color:var(--text-3);font-family:\"DM Mono\",monospace'>no data</span>"
            if not neg_bars_html:
                neg_bars_html = "<span style='font-size:0.67rem;color:var(--text-3);font-family:\"DM Mono\",monospace'>no data</span>"
            ...
            <div style='background:var(--surface);border:1px solid var(--border);
                ...
                <div style='display:flex;justify-content:space-between;align-items:center;
                    ...
                    <span style='font-size:0.75rem;font-weight:600;
                                 color:{meta_k["color"]};font-family:"DM Sans",sans-serif;
                                 display:flex;align-items:center;gap:0.35rem'>
                        <span style='font-size:0.85rem'>{meta_k["icon"]}</span>
                        {d["label"]}
                    </span>
                    <div style='display:flex;align-items:center;gap:0.5rem'>
                ...
                <div style='display:grid;grid-template-columns:1fr 1fr;gap:0.65rem'>
                    ...
                    <div>
                        <div style='font-size:0.6rem;font-weight:700;text-transform:uppercase;
                                    letter-spacing:0.09em;color:#dc2626;
                                    font-family:"DM Mono",monospace;margin-bottom:0.35rem;
                                    display:flex;align-items:center;gap:0.3rem'>
                            <span style='width:6px;height:6px;border-radius:50%;
                                         background:#dc2626;display:inline-block'></span>
                            Negative · {d["total_neg"]}
                        </div>
                        {neg_bars_html}
                    </div>
                </div>
