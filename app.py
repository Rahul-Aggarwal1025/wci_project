...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    if sel in all_means.index:
        ...
        st.markdown(f"""
        <div style='border:1px solid var(--border);border-radius:var(--r-md);
                    background:var(--surface);box-shadow:var(--shadow-sm);
                    overflow-x:auto;margin-bottom:1.2rem'>
            <div style='padding:0.7rem 0.9rem;border-bottom:1px solid var(--border);
                        display:flex;justify-content:space-between;align-items:center'>
                <span style='font-size:0.68rem;font-weight:700;text-transform:uppercase;
                             letter-spacing:0.1em;color:var(--emerald);
                             font-family:"DM Mono",monospace'>◈ WCI Decomposition</span>
    ...
    if sel in all_means.index:
        ...
        with wsk_col_l:
            ...
            <div style='background:var(--surface);border:1px solid rgba(5,150,105,0.25);
                        ...
                        padding:1.1rem 1.4rem;box-shadow:var(--shadow-sm);height:100%'>
                <div style='font-size:0.63rem;font-weight:700;text-transform:uppercase;
                            letter-spacing:0.12em;color:#1a8a4a;margin-bottom:0.55rem;
                            font-family:"DM Mono",monospace'>✦ Highest Contributing Theme</div>
                <div style='font-family:"DM Serif Display",serif;font-size:1.35rem;
                            color:#1a8a4a;line-height:1.1;margin-bottom:0.55rem'>
                    {tc['icon']} {tc['theme']}</div>
                <div style='display:grid;grid-template-columns:repeat(3,1fr);
                            gap:0.8rem;font-family:"DM Mono",monospace;font-size:0.7rem'>
        ...
        with wsk_col_r:
            ...
            <div style='background:var(--surface);border:1px solid rgba(220,38,38,0.22);
                        ...
                        padding:1.1rem 1.4rem;box-shadow:var(--shadow-sm);height:100%'>
                <div style='font-size:0.63rem;font-weight:700;text-transform:uppercase;
                            letter-spacing:0.12em;color:#ef4444;margin-bottom:0.55rem;
                            font-family:"DM Mono",monospace'>⚑ Lowest Contributing Theme</div>
                <div style='font-family:"DM Serif Display",serif;font-size:1.35rem;
                            color:#ef4444;line-height:1.1;margin-bottom:0.55rem'>
                    {tc['icon']} {tc['theme']}</div>
                <div style='display:grid;grid-template-columns:repeat(3,1fr);
                            gap:0.8rem;font-family:"DM Mono",monospace;font-size:0.7rem'>
                    <div><span style='color:var(--text-3)'>Raw score</span><br>
    ...
    with trend_col:
        ...
        with tc3:
            if _preset == "Custom":
                ...
                st.markdown(
                    f"<div style='font-size:0.68rem;color:var(--text-3);font-family:\"DM Mono\",monospace;"
                    f"padding-top:0.55rem'>{_yr_from} → {_yr_to}</div>",
                    unsafe_allow_html=True,
                )
        ...
        if len(trend_df) >= 2:
            ...
            <div style='display:flex;gap:0.55rem;margin-bottom:0.65rem;flex-wrap:wrap'>
                <div style='background:rgba(5,150,105,0.06);border:1px solid rgba(5,150,105,0.14);
                            border-radius:var(--r-sm);padding:0.38rem 0.75rem;display:flex;
                            align-items:center;gap:0.45rem'>
                    <span style='font-size:0.6rem;text-transform:uppercase;letter-spacing:0.09em;
                                 color:var(--text-3);font-family:"DM Mono",monospace'>Avg Sentiment</span>
                    <span style='font-size:0.85rem;font-family:"DM Serif Display",serif;
                                 color:{"#059669" if _t_mean >= 0 else "#dc2626"}'>{_t_mean:+.3f}</span>
                </div>
                <div style='background:rgba(5,150,105,0.06);border:1px solid rgba(5,150,105,0.14);
                            border-radius:var(--r-sm);padding:0.38rem 0.75rem;display:flex;
                            align-items:center;gap:0.45rem'>
                    <span style='font-size:0.6rem;text-transform:uppercase;letter-spacing:0.09em;
                                 color:var(--text-3);font-family:"DM Mono",monospace'>Trend</span>
                    <span style='font-size:0.8rem;font-weight:600;color:{_t_dir_c};
                                 font-family:"DM Sans",sans-serif'>{_t_dir}</span>
                </div>
                <div style='background:rgba(5,150,105,0.06);border:1px solid rgba(5,150,105,0.14);
                            border-radius:var(--r-sm);padding:0.38rem 0.75rem;display:flex;
                            align-items:center;gap:0.45rem'>
                    <span style='font-size:0.6rem;text-transform:uppercase;letter-spacing:0.09em;
                                 color:var(--text-3);font-family:"DM Mono",monospace'>Δ</span>
                    <span style='font-size:0.85rem;font-family:"DM Serif Display",serif;
                                 color:{"#059669" if _t_delta >= 0 else "#dc2626"}'>{_t_delta:+.3f}</span>
                </div>
                <div style='background:rgba(5,150,105,0.06);border:1px solid rgba(5,150,105,0.14);
                            border-radius:var(--r-sm);padding:0.38rem 0.75rem;display:flex;
                            align-items:center;gap:0.45rem'>
                    <span style='font-size:0.6rem;text-transform:uppercase;letter-spacing:0.09em;
                                 color:var(--text-3);font-family:"DM Mono",monospace'>Volatility</span>
                    <span style='font-size:0.85rem;font-family:"DM Serif Display",serif;
                                 color:var(--text)'>{_t_vol:.3f}</span>
                </div>
                <div style='background:rgba(5,150,105,0.06);border:1px solid rgba(5,150,105,0.14);
                            border-radius:var(--r-sm);padding:0.38rem 0.75rem;display:flex;
                            align-items:center;gap:0.45rem'>
                    <span style='font-size:0.6rem;text-transform:uppercase;letter-spacing:0.09em;
                                 color:var(--text-3);font-family:"DM Mono",monospace'>Periods</span>
                    <span style='font-size:0.85rem;font-family:"DM Serif Display",serif;
                                 color:var(--text)'>{_n_pts}</span>
                </div>
            </div>
            """, unsafe_allow_html=True)
        ...
        if len(trend_df) >= 2:
                ...
                if len(_recent) > 0:
                    ...
                    for _, _pr in _recent.iterrows():
                        ...
                        _change_cells += (
                            ...
                            f"<div style='font-size:0.62rem;color:var(--text-3);"
                            f"font-family:\"DM Mono\",monospace'>{_pr['date'].strftime('%b %Y')}</div>"
                            f"<div style='font-size:0.8rem;font-family:\"DM Serif Display\",serif;"
                            f"color:{_clr_c}'>{_arrow}{abs(_c):.3f}</div>"
                            f"</td>"
                        )
                    st.markdown(f"""
                    <div style='margin-top:-0.2rem;border:1px solid var(--border);
                                border-radius:var(--r-sm);background:var(--surface);
                                overflow:hidden'>
                        <div style='padding:0.3rem 0.6rem;background:rgba(5,150,105,0.04);
            ...
            st.markdown(f"""
            <div style='padding:1.2rem;background:rgba(180,83,9,0.05);border:1px solid rgba(180,83,9,0.18);
                        border-radius:var(--r-sm);font-size:0.8rem;color:#92400e;
                        font-family:"DM Sans",sans-serif'>
    ...
    with phrase_col:
        ...
        st.markdown('<div class="sec-title" style="font-size:1rem">Theme Keyword Signal</div>',
                    unsafe_allow_html=True)
        st.markdown("""
        <div style='font-size:0.75rem;color:var(--text-3);margin-bottom:0.85rem;
