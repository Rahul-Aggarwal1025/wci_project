        ...
        for d in kw_data:
            ...
            for kw, cnt in d["top_pos"]:
                ...
                pos_bars_html += (
                    ...
                    "<span style='font-size:0.67rem;font-family:DM Mono,monospace;"
                    "color:#059669;width:74px;flex-shrink:0;"
                    "white-space:nowrap;overflow:hidden;text-overflow:ellipsis'>" + kw + "</span>"
                    "<div style='flex:1;background:rgba(5,150,105,0.08);border-radius:999px;"
                    "height:5px;overflow:hidden;min-width:40px'>"
                    "<div style='background:#059669;width:" + str(bar_w) + "%;height:5px;"
                    "border-radius:999px;opacity:0.82'></div></div>"
                    "<span style='font-size:0.63rem;color:#9ca3af;"
                    "font-family:DM Mono,monospace;width:20px;"
                    "text-align:right;flex-shrink:0'>" + str(cnt) + "</span>"
                    "</div>"
                )
            ...
            for kw, cnt in d["top_neg"]:
                ...
                neg_bars_html += (
                    "<div style='display:flex;align-items:center;gap:0.45rem;margin-bottom:0.28rem'>"
                    "<span style='font-size:0.67rem;font-family:DM Mono,monospace;"
                    "color:#dc2626;width:74px;flex-shrink:0;"
                    "white-space:nowrap;overflow:hidden;text-overflow:ellipsis'>" + kw + "</span>"
                    "<div style='flex:1;background:rgba(220,38,38,0.08);border-radius:999px;"
                    "height:5px;overflow:hidden;min-width:40px'>"
                    "<div style='background:#dc2626;width:" + str(bar_w) + "%;height:5px;"
                    "border-radius:999px;opacity:0.82'></div></div>"
                    "<span style='font-size:0.63rem;color:#9ca3af;"
                    "font-family:DM Mono,monospace;width:20px;"
                    "text-align:right;flex-shrink:0'>" + str(cnt) + "</span>"
            ...
            card_html = (
                ...
                "border-left:3px solid " + meta_k["color"] + ";border-radius:var(--r-md);"
                "padding:0.75rem 0.9rem;margin-bottom:0.55rem;box-shadow:var(--shadow-sm)'>"

                # Header row
                "<div style='display:flex;justify-content:space-between;align-items:center;"
                "margin-bottom:0.6rem'>"
                "<span style='font-size:0.75rem;font-weight:600;color:" + meta_k["color"] + ";"
                "font-family:DM Sans,sans-serif'>"
                + meta_k["icon"] + " " + d["label"] +
                "</span>"
                "<div style='display:flex;align-items:center;gap:0.5rem'>"
                "<span style='font-size:0.6rem;text-transform:uppercase;letter-spacing:0.08em;"
                "color:var(--text-3);font-family:DM Mono,monospace'>Net</span>"
                "<span style='font-size:0.8rem;font-weight:700;color:" + net_color + ";"
                "font-family:DM Mono,monospace'>" + net_label + "</span>"
                "</div></div>"
                ...
                "<div>"
                "<div style='font-size:0.6rem;font-weight:700;text-transform:uppercase;"
                "letter-spacing:0.09em;color:#dc2626;font-family:DM Mono,monospace;"
                "margin-bottom:0.35rem;display:flex;align-items:center;gap:0.3rem'>"
                "<span style='width:6px;height:6px;border-radius:50%;"
                "background:#dc2626;display:inline-block'></span>"
                "Negative &middot; " + str(d["total_neg"]) +
                "</div>"
                + neg_bars_html +
                "</div>"
