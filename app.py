...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    <div style='background:var(--surface);border:1px solid var(--border);
                ...
                padding:1.1rem 1.5rem;box-shadow:var(--shadow-sm);margin-bottom:1.2rem'>

        <div style='display:flex;align-items:center;flex-wrap:wrap;
                    gap:0.4rem;margin-bottom:0.85rem'>
            <span style='font-weight:700;color:{color};font-size:0.9rem;
                         font-family:"DM Mono",monospace'>Rank #{rank} of {len(scores)}</span>
            <span style='color:var(--border-2);font-size:0.9rem;margin:0 0.2rem'>&nbsp;/&nbsp;</span>
            <span style='font-size:0.82rem;color:var(--text-2);font-family:"DM Mono",monospace'>
                WCI <b style='color:{color}'>{wci:.1f}</b>
                &nbsp;/&nbsp; peer avg <b>{peer_avg_wci:.1f}</b>
                &nbsp;/&nbsp; range [{wci_min_all:.1f} - {wci_max_all:.1f}]
            </span>
            {caveat_note}
        </div>
        ...
        <div style='display:flex;align-items:center;gap:0.75rem;margin-bottom:0.85rem'>
            <span style='font-size:0.62rem;color:var(--text-3);
                         font-family:"DM Mono",monospace;width:16px'>0</span>
            <div style='flex:1;background:rgba(5,150,105,0.08);border-radius:999px;
                        height:7px;overflow:hidden;border:1px solid rgba(5,150,105,0.12);
                        position:relative'>
                <div style='position:absolute;left:{_peer_tick}%;top:0;bottom:0;
                            width:1.5px;background:rgba(5,150,105,0.35)'></div>
                <div style='background:linear-gradient(90deg,{color},{color}88);
                            width:{wci_pct}%;height:7px;border-radius:999px'></div>
            </div>
            <span style='font-size:0.62rem;color:var(--text-3);
                         font-family:"DM Mono",monospace;width:24px'>100</span>
        </div>
        ...
        for d in kw_data:
            ...
            for kw, cnt in d["top_pos"]:
                ...
                <div style='display:flex;align-items:center;gap:0.45rem;margin-bottom:0.28rem'>
                    ...
                    <span style='font-size:0.63rem;color:#9ca3af;font-family:DM Mono,monospace;
                                 width:20px;text-align:right;flex-shrink:0'>{cnt}</span>
                </div>
                """
        ...
        for col, icon, title, rows in signal_data:
            with col:
                ...
                for lbl, val, clr, sub in rows:
                    sub_html = (
                        f"<span style='font-size:0.65rem;color:var(--text-3);margin-left:0.3rem'>"
                        f"{sub}</span>"
                    ) if sub else ""
                    rows_html += f"""
