...
if page == "◈  Home & Leaderboard":
    ...
    _yr_span  = _yr_max - _yr_min + 1  # inclusive: 2018–2024 = 7 years, not 6
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    <div style='background:var(--surface);border:1px solid var(--border);
        ...
        <div style='display:flex;align-items:center;gap:0.75rem;margin-bottom:0.85rem'>
            ...
            <div style='flex:1;background:rgba(5,150,105,0.08);border-radius:999px;height:7px;
                        overflow:hidden;border:1px solid rgba(5,150,105,0.12);position:relative'>
                <div style='position:absolute;left:{int(round(peer_avg_wci))}%;top:0;bottom:0;width:1.5px;
                            background:rgba(5,150,105,0.35)'></div>
        ...
        <div style='display:flex;flex-wrap:wrap;gap:1.6rem'>
            <div style='font-family:"DM Mono",monospace;font-size:0.72rem'>
                ...
                <span style='color:#d97706;font-weight:600'>{avg_rat:.2f}</span>
            ...
            <div style='font-family:"DM Mono",monospace;font-size:0.72rem'>
                ...
                <span style='color:var(--text);font-weight:600'>{len(comp_all):,}</span>
